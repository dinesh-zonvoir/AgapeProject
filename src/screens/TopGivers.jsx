    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.toolbar}>
                ...
                <Text style={styles.text}>Top Givers</Text>
                ...
                renderItem={({ item, index }) => {
                    return <View style={styles.itemView}>
                        ...
                        <View style={{ paddingLeft: 10, flex: 2 }}>
                            ...
                            <Text style={{fontSize:13}}>{item.description.length > 10 ? item.description.substring(0, 10) + '...' : item.description}</Text>
                        </View>
